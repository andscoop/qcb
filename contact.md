...
<form id="contact-form" class="form-horizontal" action="https://getsimpleform.com/messages?form_api_token=066ae35c26c7a4f497cb4f7d07c342fd" method="POST" enctype="multipart/form-data">
       <fieldset>
        ...
        <input type="hidden" name='redirect_to' value="queencitybrews.com/thank-you/" />
    </fieldset>  
